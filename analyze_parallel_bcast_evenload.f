...
c
c
      program analyze_parallel_bcast_evenload
      implicit none
      include 'sizes.i'
      include 'atoms.i'
      include 'files.i'
      ...
      include 'neigh.i'
      logical doanalysis
      integer i1,i3,ii,k,moli2,moli3,count3
      real*8 energy,step
      real*8 cutoff
...
c    First, call switch to set up the calculation for the infinite
c    cutoff specified by the 'MPOLE' flag.  Call barrier to ensure that all tasks have
...
c    iteration, in addition to the number of iterations specified by
c    'offset'.  This is for load balancing.
